...
import 'package:bai2/widgets/icon_and_text_widget.dart';
      ...
      children: [
        ...
        GetBuilder<RecommendedProductController>(builder: (recommendedProduct){
          return recommendedProduct.isLoaded?ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: recommendedProduct.recommenedProductList.length,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                                image: NetworkImage(
                                    AppConstants.BASE_URL+AppConstants.UPLOAD_URL + recommendedProduct.recommenedProductList[index].img!
                                )
                            ),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  BigText(text: recommendedProduct.recommenedProductList[index].name!),
                                  SizedBox(height: Dimensions.height10,),
                                  SmallText(text: recommendedProduct.recommenedProductList[index].name!),
                                  SizedBox(height: Dimensions.height10,),
                                  Row(
